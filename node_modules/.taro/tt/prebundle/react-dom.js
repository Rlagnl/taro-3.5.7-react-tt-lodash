import { require_react } from "./chunk-4MRLETOA.js";
import { FormElement, document$1, init_runtime_esm } from "./chunk-YEXS3KCA.js";
import { EMPTY_ARR, capitalize, ensure, init_shared_esm, internalComponents, isBoolean, isFunction, isNumber, isObject, isString, isUndefined, noop, toCamelCase } from "./chunk-AFNOH6ET.js";
...
var scheduler = __toESM(require_scheduler2());
...
var hostConfig = {
    ...
    queueMicrotask: !isUndefined(Promise) ? (callback)=>Promise.resolve(null).then(callback).catch(function(error) {
            setTimeout(()=>{
                throw error;
            });
        }) : setTimeout,
