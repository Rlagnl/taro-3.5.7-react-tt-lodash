import { r as registerInstance, h, g as getElement, H as Host } from './index-8809c729.js';

const areaCss = "taro-movable-area-core{display:block;height:10px;width:10px;position:relative}";
...
export { MovableArea as taro_movable_area_core };
