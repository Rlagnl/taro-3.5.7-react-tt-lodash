...
class BuildNativePlugin extends MiniPlugin_1.default {
    ...
    addLoadChunksPlugin(compiler) {
        ...
        compiler.hooks.thisCompilation.tap(PLUGIN_NAME, compilation => {
                ...
                for (const chunk of chunks) {
                    ...
                    for (const group of chunk.groupsIterable) {
                        group.chunks.forEach(chunk => {
                            const currentChunkId = (0, webpack_2.getChunkIdOrName)(chunk);
            ...
            webpack_1.default.javascript.JavascriptModulesPlugin.getCompilationHooks(compilation).render.tap(PLUGIN_NAME, (modules, { chunk }) => {
                if (!(0, webpack_2.getChunkEntryModule)(compilation, chunk))
                    return modules;
                // addChunkPages
                if (fileChunks.size) {
                    let source;
    ...
    addLoader(compiler) {
        compiler.hooks.compilation.tap(PLUGIN_NAME, compilation => {
            webpack_1.default.NormalModule.getCompilationHooks(compilation).loader.tap(PLUGIN_NAME, (_loaderContext, module) => {
