...
class H5WebpackPlugin {
    ...
    getDefinePlugin() {
        const { env = {}, defineConstants = {} } = this.combination.config;
    ...
    getHtmlWebpackPlugin(entry = '', chunks = []) {
        var _a, _b, _c, _d;
        ...
        const args = {
            ...
            template: path_1.default.join(this.combination.sourceDir, 'index.html'),
            script: htmlScript
        };
        if (entry && entry !== 'index') {
            args.chunks = [...chunks, entry];
        }
        const htmlPluginOption = (_d = config.htmlPluginOption) !== null && _d !== void 0 ? _d : {};
    ...
    getH5Plugin() {
        var _a;
        const { appPath, sourceDir, outputDir, config } = this.combination;
        const { entryFileName = 'app', router = {}, useHtmlComponents = false } = config;
